...
constexpr std::string_view help_content =
    ...
    "   pgn import <file> --name <name>                                               load a pgn to game directory\n"
    "   pgn export <name> --output <file>                                             export a saved pgn from game directory\n\n"
    ...
    "   fen import <file> --name <name>                                               load a fen to game directory\n"
    "   fen export <name> --output <file>                                             export a saved fen from game directory\n\n"
