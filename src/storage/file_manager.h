...
std::filesystem::path make_pgn_path(std::string_view name);
std::filesystem::path make_fen_path(std::string_view name);
std::filesystem::path make_report_path(std::string_view name);
